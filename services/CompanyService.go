...
func MigrateExistingSchemas() error {
    ...
    for _, company := range companies {
        ...
        if err := database.DB.AutoMigrate(
            ...
            &models.AgriWorkPlan{},
            &models.AgriWorkPlanApplicationMixItem{},
			&models.AgroOperations{},
...
func CreateSchema(companyName string) error {
	...
	tables := []struct {
		...
		{&models.AgriWorkPlanApplicationMixItem{}, "agri_work_plan_application_mix_item"},
		{&models.AgroOperations{}, "agro_operations"},
